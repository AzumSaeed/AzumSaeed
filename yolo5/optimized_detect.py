...
if __name__ == '__main__':
    ...
    cap = cv2.VideoCapture('G:/ozone_live/video_data/4-29-2021/00000000907000000.mp4')
    cam_id = '0907'
    path_save_person = 'G:/ozone_live/Person_data/persons/cam_'+cam_id+'/'
    #print(len(images))
    device = select_device('0')
        ...
        if count_images%7 == 0:
            ...
            #ss = cv2.putText(ss, str(nn[0]), (x, y), cv2.FONT_HERSHEY_PLAIN, 2, (0, 255, 125), 3)
                ...
                try:
                    ...
                    cv2.imwrite(path_save_person+cam_id+'_'+str(persons_id)+'.jpg',ss)
                    persons_id +=1
